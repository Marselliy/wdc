...
var m = angular.module("app.widgets.v2.steps.post-process-scatter",["app.widgets.data-util.dps"]);
...
m.factory("PostProcess",["$http","Requestor", function($http, Requestor){
    ...
    html : "./widgets/v2.steps/post-process-scatter.html",
    ...
    _initSettings: function(){
	  ...
	  this.postprocessSettings.clustered = false;
	  this.postprocessSettings.clusters = 2;
	  this.postprocessSettings.includeCentroids = false;
	  this.postprocessSettings.withRadius = false;
	  this.postprocessSettings.pca = false;
            ...
            .post("./api/data/process/",
              {
                ...
                "params": 
                {
				  ...
				  "clustered": thos.postprocessSettings.clustered,
				  "clusters": thos.postprocessSettings.clusters,
				  "includeCentroids": thos.postprocessSettings.includeCentroids,
				  "withRadius": thos.postprocessSettings.withRadius,
				  "pca": thos.postprocessSettings.pca
                },
